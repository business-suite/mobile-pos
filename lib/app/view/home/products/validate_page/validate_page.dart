                ...
                child: SingleChildScrollView(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Text(
                          LocaleKeys.how_would_like_to_receive_your_receipt
                              .tr(),
                          style: TextStyle(
                              color: kColor555555, fontSize: size_25_w),
                        ),
                        SizedBox(
                          height: size_25_w,
                        ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        fontSize: text_20, color: kColor555555),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            child: Column(
                              children: [
                                ...
                                Column(
                                  children: [
                                    Text(
                                      LocaleKeys.my_company_san_francisco.tr(),
                                      style: TextStyle(color: kColor555555),
                                    ),
                                    Text(LocaleKeys.tel_16505550111.tr(),
                                        style: TextStyle(color: kColor555555)),
                                    ...
                                    Text('--------------------------------',
                                        style: TextStyle(color: kColor555555)),
                                    Text(
                                        LocaleKeys.served_by_mitchell_admin
                                            .tr(),
                                        style: TextStyle(color: kColor555555)),
                                  ],
                                ),
