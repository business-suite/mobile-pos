...
class _AddCustomerContentState extends State<AddCustomerContent> {
  AddCustomertViewModel get addCustomertViewModel =>
      widget._addCustomertViewModel;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Material(
                              ...
                              child: TextField(
                                style: TextStyle(
                                    color: kCBlack, fontSize: text_25),
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: TextStyle(
                                      fontSize: text_30, color: kCBlack),
                                  contentPadding:
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(fontSize: text_20),
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.only(
                          ...
                          child: Material(
                            ...
                            child: TextField(
                              style:
                                  TextStyle(color: kCBlack, fontSize: text_15),
                              textAlignVertical: TextAlignVertical.center,
                              decoration: InputDecoration(
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(size_5_r),
                                ...
                                hintStyle: TextStyle(
                                    fontSize: size_15_w, color: kCBlack),
                                contentPadding:
                        ...
                        Padding(
                          ...
                          child: InputDecorator(
                            decoration: InputDecoration(
                                ...
                                filled: true,
                                hintStyle: TextStyle(
                                    fontSize: size_20_w, color: kCBlack),
                                contentPadding:
                                    EdgeInsets.fromLTRB(5.0, 5.0, 10.0, 10.0),
                                focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(size_5_r),
                                  ...
                                  DropdownMenuItem(
                                      ...
                                      child: Text(LocaleKeys.none.tr(),
                                          style: TextStyle(
                                              ...
                                              color: kCBlack))),
                                  DropdownMenuItem(
                                      value: LocaleKeys.armed_forces_americas
                                          .tr()
                                          .toUpperCase(),
                                      child: Text(
                                          LocaleKeys.armed_forces_americas.tr(),
                                          style: TextStyle(
                                              fontSize: text_15,
                                              color: kCBlack))),
                                  DropdownMenuItem(
                                      value: LocaleKeys.armed_forces_europe
                                          .tr()
                                          .toUpperCase(),
                                      child: Text(
                                          LocaleKeys.armed_forces_europe.tr(),
                                          style: TextStyle(
                                              fontSize: text_15,
                                              color: kCBlack))),
                                  DropdownMenuItem(
                                      value:
                                          LocaleKeys.alaska.tr().toUpperCase(),
